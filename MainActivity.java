...
//                    n1.setText(foo);
            ...
            case R.id.sub:
                ...
                if (equalispressed && !n2.getText().toString().equals("0")) {
                    ...
                    n2isfilled = false;
                    f = 1;
                } else if ((n1isfilled && (n2.getText().toString().equals("0") || n2.getText().toString().equals("")) && ((!ops.getText().toString().equals(".") && !sci_ops) || ((!operator2.getText().equals("")) && sci_ops)) || scientific.invpressed % 2 != 0)) {
