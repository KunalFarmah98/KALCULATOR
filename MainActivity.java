            ...
            case R.id.num0:
                ...
                if (!equalispressed) {
                    if (!n1isfilled && ops.getText().toString().equals(".")) {
                        ...
                        if (!operator2.isShown() || !n2.getText().toString().contains("%")) {
                        ...
                        //res.setText(result(n1.getText().toString(), n2.getText().toString(), ops.getText().toString()).toString());
                            ...
                            Double ans = scientific.result(n1.getText().toString(), n2.getText().toString(), ops.getText().toString(), operator2.getText().toString());
                            ans = Math.round(ans.doubleValue() * 1000000.0) / 1000000.0;
                            res.setText(ans.toString());
                        }
...
//                    n1.setText(foo);
            ...
            case R.id.sub:
                ...
                if (equalispressed && !n2.getText().toString().equals("0")) {
                    ...
                    n2isfilled = false;
                    f = 1;
                } else if (((n1isfilled && !ops.getText().toString().equals(".") || scientific.invpressed % 2 == 0) && !sci_ops) ){
                    n2.setText("-");
                    n2isfilled = true;
                } else if ((n1isfilled && n2isfilled && !(ops.getText().toString().equals(".")) && !sci_ops)
                        ) {
...
//                    n1.setText(foo);
            ...
            case R.id.equals:
                ...
                if ((sci_used || operator2.isShown()) && eq == 0) {
