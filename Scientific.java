...
//                    } else if (!ops2.equals("")) {
//                        Double temp = Math.toDegrees(java.lang.Math.acos(1d/Double.parseDouble(n2)));
//                        ans = var.result(n1, temp.toString(), ops2);
//                    }
//                }
//                else if(angleval.equals("RAD")) {
...
//
//                    else if(!ops2.equals("")){
//                        Double temp = (java.lang.Math.acos(1d/Double.parseDouble(n2)));
//                        ans = var.result(n1, temp.toString(), ops2);
//                    }
//
//                }
...
//                    } else if (!ops2.equals("")) {
//                        Double temp = Math.toDegrees(java.lang.Math.asin(1d/Double.parseDouble(n2)));
//                        ans = var.result(n1, temp.toString(), ops2);
//                    }
//                }
//                else if(angleval.equals("RAD")) {
...
//
//                    else if(!ops2.equals("")){
//                        Double temp = (java.lang.Math.asin(1d/Double.parseDouble(n2)));
//                        ans = var.result(n1, temp.toString(), ops2);
//                    }
//
//                }
...
//                    } else if (!ops2.equals("")) {
//                        Double temp = Math.toDegrees(java.lang.Math.atan(1d/Double.parseDouble(n2)));
//                        ans = var.result(n1, temp.toString(), ops2);
//                    }
//                }
//                else if(angleval.equals("RAD")) {
...
//
//                    else if(!ops2.equals("")){
//                        Double temp = (java.lang.Math.atan(1d/Double.parseDouble(n2)));
//                        ans = var.result(n1, temp.toString(), ops2);
//                    }
//
//                }
