...
public String ops2 = "";
    ...
    private Double result(String n1, String n2, String ops, String ops2) {
            ...
            case "sin":
                if (angleval.equals("DEG")) {
                    ...
                    if(ops2.equals(null)) {
                       ...
                       else if(!ops2.equals(null)){

                        Double temp = java.lang.Math.sin((Double.parseDouble(n2)));    // calcuating the sin result
