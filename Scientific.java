    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.sin:
                ...
                // to reset everything after equals is pressed or vies are occupied

        else if((var.n1isfilled && var.n2isfilled && !ops.getText().toString().equals(".")&&!var.equalispressed)){
            ...
            case R.id.cos:
                ...
                // to reset everything after equals is pressed or views are occupied
